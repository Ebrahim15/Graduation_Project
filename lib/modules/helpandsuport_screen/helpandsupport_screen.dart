                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: TextFormField(
                          ...
                          controller: HelpAndSupportCubit.get(context).controller,
                          key: HelpAndSupportCubit.get(context).dialogKey,
                          maxLines: 6,
                          maxLength: 200,
                    ...
                    defaultLogInOutButton(
                      buttonText: 'submit',
                      onPressed: () async {
                        print(HelpAndSupportCubit.get(context).controller.text);
                        if (HelpAndSupportCubit.get(context)
                            .dialogKey
                            .currentState!
                            .validate()) {
                          String massage;
                          try {
                            ...
                            await collection.doc().set({
                              ...
                              'feedback':HelpAndSupportCubit.get(context).controller.text,
                            });
